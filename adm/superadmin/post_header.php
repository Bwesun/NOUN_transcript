    ...
    <header class="site-header">
        <nav class="navbar navbar-light bg-success fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"  style="color:white;"> <strong>NOUN Transcript Portal</strong> | Super Admin Dashboard</a>
                ...
                <div class="offcanvas-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="create_admin.php">
