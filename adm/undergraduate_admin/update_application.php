    ...
    <main class="container">
        <div class="card">
            <div class="card-header text-center">
              <h4>Update Undergraduate Transcript Application </h4>
            </div>
            <div class="card-body">
                <fieldset>
...
if(isset($_POST['sub_update'])){
    ...
    $sql="UPDATE undergraduate SET status='$status', typed_by='$typed_by', date_of_verification='$date_of_verification', comment='$comment', date_sent='$date_sent', tracking_code='$tracking_code' WHERE id='$hidden_id' ";
    $result=mysqli_query($conn, $sql);
...
?>
                <form method="post"><?php echo $rows['status']; ?>
                <div class="row g-2">
                    <div class="col-md">
