<?php 
include('undergraduate_header.php');
?>
    ...
    <main class="container">
        <div class="card">
            <div class="card-header text-center">
              <h2>Undergraduate Transcript Application Form</h2>
            </div>
    ...
    if($count==0){
        ...
        $insert_id=mysqli_insert_id($conn);//Last Insert ID
            if($result){
                ...
                echo "<script>window.open('view_application.php?id=".$insert_id."', '_self')</script>";
                    ...
                    <div class="col-md">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" name="programme" aria-label="Floating label select example" required>
                                ...
                                <option value="B.Sc. Physics">B.Sc. Physics</option><option value="B.Sc. Biology">B.Sc. Biology</option><option value="B.Sc. Chemistry">B.Sc. Chemistry</option><option value="B.Sc. Mathematics/Computer Science">B.Sc. Mathematics/Computer Science</option><option value="B.Sc. Mathematics">B.Sc. Mathematics</option><option value="B.Sc. Environmental Management and Toxicology">B.Sc. Environmental Management and Toxicology</option><option value="B.Sc. Computer Science">B.Sc. Computer Science</option><option value="B.Sc. Information Technology">B.Sc. Information Technology</option><option value="B.Sc. Banking and Finance">B.Sc. Banking and Finance</option><option value="B.Sc. Marketing">B.Sc. Marketing</option><option value="B.Sc. Public Administration">B.Sc. Public Administration</option><option value="B.Sc. Business Administration">B.Sc. Business Administration</option><option value="B.Sc. Accounting">B.Sc. Accounting</option><option value="B.Sc. Entrepreneurship">B.Sc. Entrepreneurship</option><option value="B.Sc. Cooperative and Rural Development">B.Sc. Cooperative and Rural Development</option><option value="B.Sc. Environmental Health">B.Sc. Environmental Health</option><option value="B.Sc. Public Health">B.Sc. Public Health</option><option value="B.NSc Bachelor of Nursing Science">B.NSc Bachelor of Nursing Science</option><option value="B.Sc. Tourism Studies">B.Sc. Tourism Studies</option><option value="B.Sc Economics">B.Sc Economics</option><option value="B.Sc. Political Science">B.Sc. Political Science</option><option value="B.Sc. Mass Communication">B.Sc. Mass Communication</option><option value="B.Sc. Peace Studies and Conflict Resolution">B.Sc. Peace Studies and Conflict Resolution</option><option value="B.Sc. Criminology and Security Studies">B.Sc. Criminology and Security Studies</option><option value="B.Sc.(Ed) Agricultural Science">B.Sc.(Ed) Agricultural Science</option><option value="B.Sc.(Ed) Biology">B.Sc.(Ed) Biology</option><option value="B.Sc.(Ed) Chemistry">B.Sc.(Ed) Chemistry</option><option value="B.Sc.(Ed) Integrated Science">B.Sc.(Ed) Integrated Science</option><option value="B.Sc.(Ed) Computer Science">B.Sc.(Ed) Computer Science</option><option value="B.Sc.(Ed) Mathematics">B.Sc.(Ed) Mathematics</option><option value="B.Sc.(Ed) Physics">B.Sc.(Ed) Physics</option><option value="B.A.(Ed) Early Childhood Education">B.A.(Ed) Early Childhood Education</option><option value="B.A.(Ed) English">B.A.(Ed) English</option><option value="B.A.(Ed) French">B.A.(Ed) French</option><option value="B.A.(Ed) Primary Education">B.A.(Ed) Primary Education</option><option value="B.Sc.(Ed) Business Education">B.Sc.(Ed) Business Education</option><option value="LLB Law">LLB Law</option><option value="B.A. English">B.A. English</option><option value="B.A. French">B.A. French</option><option value="B.A. Christian Religious studies">B.A. Christian Religious studies</option><option value="B.A. Islamic Studies">B.A. Islamic Studies</option><option value="B.Sc. Hotel and Catering Management">B.Sc. Hotel and Catering Management</option><option value="B. Agric. (Animal Science Option)">B. Agric. (Animal Science Option)</option><option value="B. Agric. (Aquaculture and Fisheries Management Option)">B. Agric. (Aquaculture and Fisheries Management Option)</option><option value="B. Agric. (Agricultural Economics and Agro Business Option)">B. Agric. (Agricultural Economics and Agro Business Option)</option><option value="B. Agric. (Soil and Land Resources Management Option)">B. Agric. (Soil and Land Resources Management Option)</option><option value="B. Agric. (Crop Production and Protection Sciences Option)">B. Agric. (Crop Production and Protection Sciences Option)</option><option value="B. Agric. (Agricultural Extension and Rural Development Option)">B. Agric. (Agricultural Extension and Rural Development Option)</option><option value="B.Sc Agricultural Extension and Management">B.Sc Agricultural Extension and Management</option><option value="B.Sc. Data Management">B.Sc. Data Management</option><option value="B.Sc. International and Diplomatic Studies">B.Sc. International and Diplomatic Studies</option>
                            </select>
